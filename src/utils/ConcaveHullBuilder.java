...
public class ConcaveHullBuilder {
    ...
    private void demo() {
        ...
        Coordinate[] vertices =
                { new Coordinate(0, 0), new Coordinate(100, 100), new Coordinate(0, 250), new Coordinate(200, 300),
                        new Coordinate(200, 450), new Coordinate(350, 450), new Coordinate(350, 200), new Coordinate(250, 200),
                        new Coordinate(350, 100), new Coordinate(0, 0) };
        ...
        display((int) (env.getWidth() * 1.1), (int) (env.getHeight() * 1.1), poly, Color.GRAY, points, Color.RED, edges,
                Color.RED);
    }
    ...
    public static Geometry getConcaveHullGeo(Point[] points, double alpha) throws Exception {
        ...
        cl.add(edges.get(0).getStartPoint().getCoordinate());
     ...
     */
    private void display(int w, int h, final Polygon poly, final Color polyCol, final Point[] points, final Color pointCol,
